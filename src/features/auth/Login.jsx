...
export default function Login({ handleLogin, handleMessage }) {
  ...
  function handleSubmit(e) {
    ...
    fetch("http://localhost:5000/login-user", {
      ...
      .then((data) => {
        ...
        } else handleMessage({messageText: "Invalid Userdata. Try again.", messageType: "negative"});
      });
  }

  function handleGuestLogin() {
    window.localStorage.setItem("token", JSON.stringify({ fname: 'Guestuser', lname: '', userType: 'Guest' }));
    handleLogin();
  }
  ...
  return (
    <div className={styles.authContainer}>
      ...
      <button onClick={handleGuestLogin} type="button" className="btn btn-secondary">
